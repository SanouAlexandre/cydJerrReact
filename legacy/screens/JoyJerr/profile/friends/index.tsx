...
import FriendsRequestsContent from "./friendsRequests";

const AboutTabs = ({ activeTab, setActiveTab }) => {
  const tabs = [
    { key: "Friends", icon: "person-circle-outline" },
    { key: "Friend Requests", icon: "person-add-outline" },
  ];
...
const FriendsHomeContent = () => {
  // 🔥 Par défaut, "Friends" est sélectionné
