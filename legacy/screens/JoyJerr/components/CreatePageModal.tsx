...
const CreatePageModal = ({ visible, onClose, onCreatePage }) => {
  ...
  const nameCharCount = pageName.length;
  const descriptionCharCount = pageDescription.length;
        ...
        <View style={styles.modalContent}>
          ...
          >
            ...
            <View style={styles.fieldContainer}>
              ...
              <TextInput
                ...
                placeholder="Enter your page's description ..."
          ...
          <View style={styles.modalActions}>
            ...
            <TouchableOpacity 
              style={[
                styles.createButton,
                !pageName.trim() && styles.createButtonDisabled
              ]} 
            ...
            >
              <Text style={[
                ...
                !pageName.trim() && styles.createButtonTextDisabled
              ]}>
                Create
              </Text>
            </TouchableOpacity>
